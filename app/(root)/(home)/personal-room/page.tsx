...
const Table = ({title, description} :
  ...
  <div className="flex flex-col items-start gap-2 xl:flex-row">
    ...
    <h1 className="truncate text text-sm font-bold max-sm:max-w-[320px] lg:text-xl">{description}</h1>
  </div>
)
...
const {user} = useUser();
  ...
  const startRoom = async ()=>{
    ...
    if(!call){
      //if there is no call get new call
